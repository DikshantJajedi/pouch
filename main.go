...
func setupFlags(cmd *cobra.Command) {
	...
	flagSet.StringVar(&cfg.CriConfig.SandboxImage, "sandbox-image", "registry.cn-hangzhou.aliyuncs.com/google-containers/pause-checkArch():3.0", "The image used by sandbox container.")
